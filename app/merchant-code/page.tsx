    ...
    <div className="min-h-screen bg-[#090b0c] text-white">
      <div className="mx-auto max-w-md px-6 py-8">
        ...
        <div className="flex flex-col gap-12 mb-12">
          ...
          <div className="relative bg-[#090b0c] border border-[#35363c] rounded-lg p-5 flex items-center justify-between">
            <div className="flex flex-col gap-1 flex-1">
              <div className="text-sm text-[#8d8f99]">Your Pi UID</div>
            ...
            {merchantUid && (
              <button
                className="h-12 px-6 bg-gradient-to-r from-[#a625fc] to-[#f89318] rounded-full text-white text-base font-semibold hover:opacity-90 transition-opacity ml-4"
                onClick={() => copyToClipboard(merchantUid, "uid")}
              >
                {copySuccess === "uid" ? "Copied!" : "Copy UID"}
              </button>
            )}
          </div>
            ...
            {stage === "existing" || stage === "generated" ? (
              <>
                <div className="flex flex-col gap-1">
                  ...
                  <div className="text-base font-medium text-white">{dividendPool.toFixed(6)} Pi</div>
                </div>
                <button
                ...
                >
                  {copySuccess === "dividend" ? "Copied!" : "Copy Dividend"}
                </button>
              </>
            ) : showAmountInput ? (
              <>
                <input
                  ...
                  onBlur={() => {
                    // 失去焦点时也调用 handleAmountEnter 来验证并保存输入
                    handleAmountEnter();
                  }}
                  autoFocus
                />
              ...
              <>
                {amountEntered && startPi ? (
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="text-base font-medium text-white">{startPi} Pi</div>
                  </div>
                ) : (
        ...
        <div className="mb-6">
          {stage === "existing" || stage === "generated" ? (
            <button
              className="w-full h-16 bg-[#32363e] rounded-full text-white text-xl font-medium hover:bg-[#3a3f49] transition-colors disabled:opacity-50"
            ...
            <button
              ...
              onClick={onGenerate}
              className={`w-full h-16 rounded-full text-white text-xl font-medium transition-opacity disabled:opacity-50 disabled:cursor-not-allowed ${amountEntered
        ...
        {dividendMsg && <div className="text-green-400 text-sm mb-4">{dividendMsg}</div>}
